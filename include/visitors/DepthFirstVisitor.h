...
{
	virtual void visit( MRTCommonHeader &n 				)
	{
//		n.getTimestamp( )
//		n.getType( )
//		n.getSubType( )
...
//		n.getPeerIndexTbl()
	...
	virtual void visit( TblDumpV2RibEntry &n 				)
	{
//		n.getPeerIndex( )
//		n.getOriginatedTime( )
//		n.getAttributeLength( )
	...
	virtual void visit( BGPCommonHeader &n 				)
	{
//		n.getMarker()
//		n.getLength()
//		n.getType()
...
//		n.getNlriLength()
	...
	virtual void visit( BGPAttribute &n 					)
	{
//		n.getAttributeFlags( )
...
//		+ n.getPathSegmentsComplete() is also available
	...
	virtual void visit( AttributeTypeASPathSegment &n 	)
	{
...
//		n.getAS4( )
	...
	virtual void visit( AttributeTypeAS4PathSegment &n 	)
	{
//		n.getPathSegmentType( )
//		n.getPathSegmentLength( )
//		n.getPathSegmentValue( )
...
//		n.getOrigin( )
	...
	virtual void visit( OptionalParameter &n 				)
	{
//		n.getType( )
//		n.getLength( )
	}
	virtual void visit( OptionalParameterCapabilities &n 	)
	{
//		n.getType( )
//		n.getLength( )
...
//		+ helper methods available, see Route
	...
	virtual void visit( NLRIReachable &n				)
	{
//		n.getLength( )
//		n.getPrefix( )
//		n.getNumOctets( )
//		+ helper methods available, see Route
	...
	virtual void visit( NLRIUnReachable &n				)
	{
//		n.getLength( )
//		n.getPrefix( )
//		n.getNumOctets( )
