...
#ifndef _GJNOARGUDEPTHFIRST_H_
#define _GJNOARGUDEPTHFIRST_H_

#include "GJNoArguVisitor.h"
...
class GJNoArguDepthFirst : public GJNoArguVisitor
{
...
//		n.getLocalIP()
		...
		return n.getPayload()->accept( *this );
	}

	virtual boost::any visit( MRTBgp4MPMessageAS4 &n )
	{
		return static_cast<MRTBgp4MPMessage>( n ).accept( *this );
	}
...
//		n.getNewState( )
	...
	virtual boost::any visit( MRTBgp4MPStateChangeAS4 &n )
	{
		return static_cast<MRTBgp4MPStateChange>( n ).accept( *this );
	}
...
//		n.getPeerIndexTbl()
	...
	virtual boost::any visit( MRTTblDumpV2RibGeneric &n )
	{
		return static_cast<MRTTblDumpV2RibHeader>( n ).accept( *this );
	}
	virtual boost::any visit( MRTTblDumpV2RibIPv4Multicast &n )
	{
		return static_cast<MRTTblDumpV2RibHeader>( n ).accept( *this );
	}
	virtual boost::any visit( MRTTblDumpV2RibIPv4Unicast &n )
	{
		return static_cast<MRTTblDumpV2RibHeader>( n ).accept( *this );
	}
	virtual boost::any visit( MRTTblDumpV2RibIPv6Multicast &n )
	{
		return static_cast<MRTTblDumpV2RibHeader>( n ).accept( *this );
	}
	virtual boost::any visit( MRTTblDumpV2RibIPv6Unicast &n )
	{
		return static_cast<MRTTblDumpV2RibHeader>( n ).accept( *this );
	}

	virtual boost::any visit( TblDumpV2RibEntry &n )
	{
//		n.getPeerIndex( )
//		n.getOriginatedTime( )
//		n.getAttributeLength( )
	...
	virtual boost::any visit( BGPCommonHeader &n )
	{
//		n.getMarker()
//		n.getLength()
//		n.getType()
	...
	virtual boost::any visit( BGPKeepAlive &n )
	{
//		n.getMarker()
//		n.getLength()
//		n.getType()
	...
	virtual boost::any visit( BGPNotification &n )
	{
//		n.getMarker()
//		n.getLength()
//		n.getType()
...
//		n.getData( )
	...
	virtual boost::any visit( BGPOpen &n )
	{
//		n.getMarker()
//		n.getLength()
//		n.getType()
...
//		n.isAS4Supported( )
		...
		{
			optparam->accept( *this );
		}
		return boost::any();
	}
	virtual boost::any visit( BGPRouteRefresh &n )
	{
//		n.getMarker()
//		n.getLength()
//		n.getType()
...
//		n.getSafi( )
	...
	virtual boost::any visit( BGPUpdate &n )
	{
//		n.getMarker()
//		n.getLength()
//		n.getType()
...
//		n.getNlriLength()
	...
	virtual boost::any visit( BGPAttribute &n )
	{
//		n.getAttributeFlags( )
...
//		+ other helpers available, see BGPAttribute
	...
	virtual boost::any visit( AttributeType &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
	...
	virtual boost::any visit( AttributeTypeAS4Aggregator &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getAggregatorBGPSpeakerIPAddress( )
	...
	virtual boost::any visit( AttributeTypeASPath &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		+ n.getPathSegmentsComplete() is also available
	...
	virtual boost::any visit( AttributeTypeASPathSegment &n )
	{
...
//		n.getPathSegmentValue( )
	...
	virtual boost::any visit( AttributeTypeAS4PathSegment &n )
	{
		return static_cast<AttributeTypeASPathSegment>( n ).accept( *this );
	}

	virtual boost::any visit( AttributeTypeAS4Path &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
	...
	virtual boost::any visit( AttributeTypeAggregator &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getAggregatorBGPSpeakerIPAddress( )
	...
	virtual boost::any visit( AttributeTypeAtomicAggregate &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
	...
	virtual boost::any visit( AttributeTypeClusterList &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getClusterList( )
	...
	virtual boost::any visit( AttributeTypeCommunities &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getCommunityValues( )
	...
	virtual boost::any visit( AttributeTypeExtCommunities &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getExtCommunityValues( )
	...
	virtual boost::any visit( AttributeTypeLocalPref &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getLocalPrefValue( )
	...
	virtual boost::any visit( AttributeTypeMPReachNLRI &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getNextHopAddressLocal( )
	...
	virtual boost::any visit( AttributeTypeMPUnreachNLRI &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getSAFI( )
	...
	virtual boost::any visit( AttributeTypeMultiExitDisc &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getMultiExitDiscValue( )
	...
	virtual boost::any visit( AttributeTypeNextHop &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getNextHopAFI( )
	...
	virtual boost::any visit( AttributeTypeOrigin &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getOrigin( )
	...
	virtual boost::any visit( AttributeTypeOriginatorID &n )
	{
//		n.getLength( )
//		n.getData( )
//		n.getAS4( )
...
//		n.getOrigin( )
	...
	virtual boost::any visit( OptionalParameter &n )
	{
//		n.getType( )
//		n.getLength( )
		return boost::any();
	}
	virtual boost::any visit( OptionalParameterCapabilities &n )
	{
//		n.getType( )
//		n.getLength( )
...
//		n.getCapValue( )
	...
	virtual boost::any visit( Route &n )
	{
//		n.getLength( )
//		n.getPrefix( )
//		n.getNumOctets( )
//		+ helper methods available, see Route
	...
	virtual boost::any visit( NLRIReachable &n )
	{
//		n.getLength( )
//		n.getPrefix( )
//		n.getNumOctets( )
//		+ helper methods available, see Route
	...
	virtual boost::any visit( NLRIUnReachable &n )
	{
//		n.getLength( )
//		n.getPrefix( )
//		n.getNumOctets( )
