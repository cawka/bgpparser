...
void
SimplePrinter::printTimestamp(const MRTMessage& mrt)
{
...
void
SimplePrinter::visit(MRTBgp4MPMessage& n)
{
  printTimestamp(n);
  cout << "TYPE: BGP4MP/BGP4MP_MESSAGE"
       << "\n";

  cout << "FROM: " << FORMAT_IP_ADDRESS(n.getPeerIP(), n.getAddressFamily()) << " AS"
       << n.getPeerAS() << "\n";
  cout << "TO: " << FORMAT_IP_ADDRESS(n.getLocalIP(), n.getAddressFamily()) << " AS"
       << n.getLocalAS() << "\n";
...
void
SimplePrinter::visit(MRTBgp4MPStateChange& n)
{
  printTimestamp(n);
...
void
SimplePrinter::visit(MRTBgp4MPMessageAS4& n)
{
  printTimestamp(n);
...
void
SimplePrinter::visit(MRTBgp4MPStateChangeAS4& n)
{
  printTimestamp(n);
...
void
SimplePrinter::visit(MRTTblDump& n)
{
  printTimestamp(n);
  ...
  cout << n.getViewNumber() << "|" << n.getSequenceNumber() << "|"
       ...
       << n.getStatus() << "|" << FORMAT_IP_ADDRESS(n.getPeerIP(), n.getSubType()) << "|"
       << n.getPeerAS();
...
void
SimplePrinter::visit(MRTTblDumpV2RibHeader& n)
{
  cout << "PREFIX: " << FORMAT_IP_ADDRESS(n.getPrefix(), n.getAFI()) << "/"
       << (int)n.getPrefixLength() << endl;
  cout << "SEQUENCE: " << n.getSequenceNumber();
}

void
SimplePrinter::visit(MRTTblDumpV2PeerIndexTbl& n)
{
  printTimestamp(n);
...
void
SimplePrinter::visit(MRTTblDumpV2RibGeneric& n)
{
  printTimestamp(n);
...
void
SimplePrinter::visit(MRTTblDumpV2RibIPv4Multicast& n)
{
  printTimestamp(n);
...
void
SimplePrinter::visit(MRTTblDumpV2RibIPv4Unicast& n)
{
  printTimestamp(n);
...
void
SimplePrinter::visit(MRTTblDumpV2RibIPv6Multicast& n)
{
  printTimestamp(n);
...
void
SimplePrinter::visit(MRTTblDumpV2RibIPv6Unicast& n)
{
  printTimestamp(n);
...
void
SimplePrinter::visit(BGPKeepAlive& n)
{
...
void
SimplePrinter::visit(BGPNotification& n)
{
...
void
SimplePrinter::visit(BGPOpen& n)
{
  cout << "BGP MESSAGE TYPE: OPEN"
       << "\n";
}
void
SimplePrinter::visit(BGPRouteRefresh& n)
{
  cout << "BGP MESSAGE TYPE: ROUTE_REFRESH"
       << "\n";
}
void
SimplePrinter::visit(BGPUpdate& n)
{
...
void
SimplePrinter::visit(AttributeTypeMPReachNLRI& n)
{
  if (n.getAFI() == 0)
    return;
...
void
SimplePrinter::visit(AttributeTypeMPUnreachNLRI& n)
{
  if (n.getAFI() == 0)
    return;
...
void
SimplePrefixPrinter::visit(Route& n, boost::any param)
{
  uint16_t afi = boost::any_cast<uint16_t>(param);

  std::cout << FORMAT_IP_ADDRESS(n.getPrefix(), afi) << "/" << (int)n.getLength();
}

void
SimplePrefixPrinter::visit(NLRIReachable& n, boost::any param)
{
  static_cast<Route>(n).accept(*this, param);
}

void
SimplePrefixPrinter::visit(NLRIUnReachable& n, boost::any param)
{
  static_cast<Route>(n).accept(*this, param);
}

void
SimplePrinter::visit(AttributeType& n)
{
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeOrigin& n)
{
  cout << "ORIGIN: ";
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeASPath& n)
{
...
void
SimplePrinter::visit(AttributeTypeAS4Path& n)
{
  std::ostringstream os;
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeNextHop& n)
{
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeMultiExitDisc& n)
{
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeLocalPref& n)
{
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeAtomicAggregate& n)
{
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeAggregator& n)
{
  cout << "AGGREGATOR: "
...
void
SimplePrinter::visit(AttributeTypeAS4Aggregator& n)
{
  cout << "AS4_AGGREGATOR: "
       << "AS" << (int)n.getAggregatorLastAS() << " " << n.getAggregatorBGPSpeakerIPAddress().ipv4
       << endl;
}
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeCommunities& n)
{
  std::ostringstream os;
  std::string sep = "";
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeExtCommunities& n)
{
  std::ostringstream os;
  std::string sep = "";
  ...
  BOOST_FOREACH (const ExtCommunityValue& value, n.getExtCommunityValues()) {
    ...
    os << boost::format("%02x%02x%02x%02x%02x%02x") % (int)value.rchValue[0]
            % (int)value.rchValue[1] % (int)value.rchValue[2] % (int)value.rchValue[3]
            % (int)value.rchValue[4] % (int)value.rchValue[5];
    sep = " ";
  }
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeClusterList& n)
{
  cout << "CLUSTER_LIST: ";
...
//////////////////////////////////////////////////////////////////////////////
void
SimplePrinter::visit(AttributeTypeOriginatorID& n)
{
