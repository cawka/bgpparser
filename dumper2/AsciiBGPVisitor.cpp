...
void AsciiBGPVisitor::visit( MRTTblDump &n, boost::any param )
{
	...
	if( !info->parseNLRI ) NLRIReachable( n.getPrefixLength(), n.getPrefix() ).accept( *this, param );
}

void AsciiBGPVisitor::visit( MRTTblDumpV2RibHeader &n, boost::any param )
{
	InfoPtr info=boost::any_cast<InfoPtr>( param );
	info->afi=n.getAFI( );
...
void AsciiBGPVisitor::visit( BGPOpen &n, boost::any param )
{
	// prevent visiting optional headers
}

void AsciiBGPVisitor::visit( BGPUpdate &n, boost::any param )
{
...
void AsciiBGPVisitor::visit( AttributeTypeMPUnreachNLRI &n, boost::any param )
{
	if( n.getAFI()==0 ) return;
...
void AsciiBGPVisitor::visit( NLRIReachable &n, boost::any param )
{
	InfoPtr info=boost::any_cast<InfoPtr>(param);

	std::cout
		<< info->mrt_type  << "|" << info->timestamp << "|"
		<< info->dump_type << "|" // A or I
...
void AsciiBGPVisitor::visit( NLRIUnReachable &n, boost::any param )
{
	InfoPtr info=boost::any_cast<InfoPtr>(param);
...
//////////////////////////////// ORIGIN //////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void AsciiBGPVisitor::visit( AttributeTypeOrigin &n, boost::any param )
{
	InfoPtr info=boost::any_cast<InfoPtr>( param );
...
//////////////////////////////// AS PATH /////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void AsciiBGPVisitor::visit( AttributeTypeASPath &n, boost::any param )
{
...
void AsciiBGPVisitor::visit( AttributeTypeAS4Path &n, boost::any param )
{
	std::ostringstream os;
...
//////////////////////////////// NEXT HOP ////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void AsciiBGPVisitor::visit( AttributeTypeNextHop &n, boost::any param )
{
	boost::any_cast<InfoPtr>(param)->next_hop=FORMAT_IP_ADDRESS( n.getNextHopIPAddress(), n.getNextHopAFI() );
}

//////////////////////////////////////////////////////////////////////////////
////////////////////////////// MultiExitDisc /////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void AsciiBGPVisitor::visit( AttributeTypeMultiExitDisc &n, boost::any param )
{
...
////////////////////////////// LOCAL PREF ////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void AsciiBGPVisitor::visit( AttributeTypeLocalPref &n, boost::any param )
{
...
/////////////////////////// ATOMIC AGGREGATE ////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void AsciiBGPVisitor::visit( AttributeTypeAtomicAggregate &n, boost::any param )
{
...
////////////////////////////// AGGREGATOR ////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void AsciiBGPVisitor::visit( AttributeTypeAggregator &n, boost::any param )
{
	std::ostringstream os;
...
////////////////////////////// COMMUNITIES ///////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
void AsciiBGPVisitor::visit( AttributeTypeCommunities &n, boost::any param )
{
	std::ostringstream os;
	std::string sep  = "";
